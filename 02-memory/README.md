...
| `# new rule into memory` | 显式追加 memory | <code># new rule into memory</code><br><code>你的详细规则</code> | 添加较复杂的多行规则 |
| `# remember this` | 自然语言形式的 memory | <code># remember this</code><br><code>你的说明</code> | 对话式更新 memory |
